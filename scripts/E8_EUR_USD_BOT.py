"""
E8 EUR/USD BOT - OPTIMIZED
Score=2.5, Risk=2.5%, Target=2%, Stop=1%
Expected ROI: +10.55% per 90 days
"""
...
class E8EurUsdBot:
    def __init__(self):
        ...
        print("=" * 70)
        print("E8 EUR/USD BOT [OPTIMIZED]")
        print("=" * 70)
        ...
        print(f"Expected ROI: +10.55% per 90 days")
        print("=" * 70)
