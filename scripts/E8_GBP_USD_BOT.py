"""
E8 GBP/USD BOT - OPTIMIZED
Score=2.0, Risk=2.0%, Target=3%, Stop=1%
Expected ROI: +3.58% per 90 days
"""
...
class E8GbpUsdBot:
    def __init__(self):
        ...
        self.trading_hours = list(range(24))  # 24/5 - ALL HOURS (forex never sleeps!)

        print("=" * 70)
        print("E8 GBP/USD BOT [OPTIMIZED]")
        print("=" * 70)
        ...
        print(f"Expected ROI: +3.58% per 90 days")
        print("=" * 70)
