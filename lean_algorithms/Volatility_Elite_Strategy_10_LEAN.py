...
class Volatility_Elite_Strategy_10_LEAN(QCAlgorithm):
    def Initialize(self):
        ...
        # Strategy metadata
        self.strategy_name = "Volatility_Elite_Strategy_10"
        self.strategy_type = "volatility"
        self.options_type = "N/A"
        self.source = "Volatility_Research"
        self.expected_sharpe = 3.32348250812136
