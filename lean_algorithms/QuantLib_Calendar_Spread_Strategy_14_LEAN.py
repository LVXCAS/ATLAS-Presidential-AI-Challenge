...
class QuantLib_Calendar_Spread_Strategy_14_LEAN(QCAlgorithm):
    def Initialize(self):
        ...
        # Strategy metadata
        self.strategy_name = "QuantLib_Calendar_Spread_Strategy_14"
        self.strategy_type = "options"
        self.options_type = "calendar_spread"
        self.source = "QuantLib_Pricing"
        self.expected_sharpe = 3.240627693871956
        self.leverage_multiplier = 24.45608147999797
    ...
    def _rebalance_options_strategy(self):
        ...
        if hasattr(self, 'spy_option'):
            ...
            if "calendar_spread" == "long_call":
                self._execute_long_call_strategy(chain)
            elif "calendar_spread" == "iron_condor":
                self._execute_iron_condor_strategy(chain)
            elif "calendar_spread" == "straddle":
