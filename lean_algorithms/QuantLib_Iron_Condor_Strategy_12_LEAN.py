...
class QuantLib_Iron_Condor_Strategy_12_LEAN(QCAlgorithm):
    def Initialize(self):
        ...
        # Strategy metadata
        self.strategy_name = "QuantLib_Iron_Condor_Strategy_12"
        self.strategy_type = "options"
        self.options_type = "iron_condor"
        self.source = "QuantLib_Pricing"
        self.expected_sharpe = 3.5678411114039936
        self.leverage_multiplier = 21.2738974727041
