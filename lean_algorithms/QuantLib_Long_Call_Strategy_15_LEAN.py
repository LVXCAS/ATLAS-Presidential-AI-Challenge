...
class QuantLib_Long_Call_Strategy_15_LEAN(QCAlgorithm):
    def Initialize(self):
        ...
        # Strategy metadata
        self.strategy_name = "QuantLib_Long_Call_Strategy_15"
        self.strategy_type = "options"
        self.options_type = "long_call"
        self.source = "QuantLib_Pricing"
        self.expected_sharpe = 2.9930207280230836
        self.leverage_multiplier = 14.570497511329606
