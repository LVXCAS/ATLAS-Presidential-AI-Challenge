...
class QuantLib_Butterfly_Strategy_8_LEAN(QCAlgorithm):
    def Initialize(self):
        ...
        # Strategy metadata
        self.strategy_name = "QuantLib_Butterfly_Strategy_8"
        self.strategy_type = "options"
        self.options_type = "butterfly"
        self.source = "QuantLib_Pricing"
        self.expected_sharpe = 3.330104505606575
        self.leverage_multiplier = 24.886490277224993
