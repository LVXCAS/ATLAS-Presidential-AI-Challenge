...
class Qlib_Quality_Strategy_13_LEAN(QCAlgorithm):
    def Initialize(self):
        ...
        # Strategy metadata
        self.strategy_name = "Qlib_Quality_Strategy_13"
        self.strategy_type = "quality"
        self.options_type = "N/A"
        self.source = "Qlib_Research"
        self.expected_sharpe = 3.24649480640863
