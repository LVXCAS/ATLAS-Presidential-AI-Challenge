...
class Momentum_Elite_Strategy_10_LEAN(QCAlgorithm):
    def Initialize(self):
        ...
        # Strategy metadata
        self.strategy_name = "Momentum_Elite_Strategy_10"
        self.strategy_type = "momentum"
        self.options_type = "N/A"
        self.source = "Momentum_Research"
        self.expected_sharpe = 3.2590593371090564
