...
class QuantLib_Iron_Condor_Strategy_2_LEAN(QCAlgorithm):
    def Initialize(self):
        ...
        # Strategy metadata
        self.strategy_name = "QuantLib_Iron_Condor_Strategy_2"
        self.strategy_type = "options"
        self.options_type = "iron_condor"
        self.source = "QuantLib_Pricing"
        self.expected_sharpe = 3.650562704244521
        self.leverage_multiplier = 18.937425992959263
