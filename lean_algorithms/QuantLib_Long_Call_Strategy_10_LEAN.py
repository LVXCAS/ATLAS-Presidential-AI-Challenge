...
class QuantLib_Long_Call_Strategy_10_LEAN(QCAlgorithm):
    def Initialize(self):
        ...
        # Strategy metadata
        self.strategy_name = "QuantLib_Long_Call_Strategy_10"
        self.strategy_type = "options"
        self.options_type = "long_call"
        self.source = "QuantLib_Pricing"
        self.expected_sharpe = 3.469215885734509
        self.leverage_multiplier = 15.97920508368113
