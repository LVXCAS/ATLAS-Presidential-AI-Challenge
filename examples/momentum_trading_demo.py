...
async def main():
    ...
    try:
        ...
        print("✓ Technical indicator analysis (EMA, RSI, MACD)")
        print("✓ Fibonacci retracement integration")
        print("✓ Sentiment confirmation and alignment")
        print("✓ Volatility-adjusted position sizing")
        print("✓ Explainable AI with top-3 reasons")
        print("✓ Multiple market regime handling")
